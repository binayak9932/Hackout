...
const Navbar = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-black to-teal-800">
    <div className="flex items-center justify-between p-4 sm:p-6 lg:p-8">
      ...
      <div className={` text-white sm:flex text-xl space-x-4 mobile-menu-container ${mobileMenuOpen ? 'block' : 'hidden'}`}>
        {links.map((link) => (
